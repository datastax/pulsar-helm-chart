...
# To redeploy cluster:
helm upgrade pulsar /Users/devin.bost/proj/repos/pulsar-helm-chart/helm-chart-sources/pulsar --namespace pulsar --values /Users/devin.bost/proj/repos/pulsar-helm-chart/examples/kafka/dev-values-tls-all-components-and-kafka-and-oauth2-low-resource.yaml --create-namespace --debug
# Or, for full redeploy:
helm delete pulsar; k delete pvc --all; helm install pulsar /Users/devin.bost/proj/repos/pulsar-helm-chart/helm-chart-sources/pulsar --namespace pulsar --values /Users/devin.bost/proj/repos/pulsar-helm-chart/examples/kafka/dev-values-tls-all-components-and-kafka-and-oauth2-low-resource.yaml --create-namespace --debug
